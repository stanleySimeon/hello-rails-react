...
class GreetingsControllerTest < ActionDispatch::IntegrationTest
  ...
  test 'should get random greeting' do
    get random_greeting_url, as: :json
    assert_response :success
  end

  test 'should get random greeting with a specific language' do
    get random_greeting_url, params: { language: 'en' }, as: :json
    assert_response :success
  end
